...
export const profile: Profile = {
  ...
  bio: [
    ...
    '단순히 동작만 하는 로직이나, 보이기만 하는 화면을 만드는 것을 경계합니다. 견고한 로직과 잘 짜인 화면은 분리된 목표가 아니라고 생각합니다. 동작의 정확성과 구조의 안정성을 함께 확보하고, 사용자가 직접 마주하는 화면의 동선과 디테일까지 동일한 비중으로 결합해 완성도 높은 서비스를 만드는 꼼꼼한 개발자입니다.',
  ],
  avatarInitials: 'SYC',
