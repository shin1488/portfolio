...
- **PM** — 일정·범위 관리와 팀 컨벤션 주도. Spring Boot 4·Spring AI 2.0 같은 갓 릴리스된 스택을 쓰기로 한 만큼 사소한 것까지 팀 컨벤션으로 정하였습니다. API 응답 / 에러 표준, JWT 검증, 시간 처리 등 10개 항목을 문서화하고 6개 서비스에 일관 적용했습니다.
...
📄 [컨벤션 문서 원문 보기 (Notion)](https://www.notion.so/)
