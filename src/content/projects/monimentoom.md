...
- **굿즈 등록** — 굿즈 사진을 인벤토리에 업로드하고 이름·설명과 함께 관리합니다.
- **선반 전시** — 인벤토리의 굿즈를 4×4 그리드 선반에 원하는 크기로 배치합니다(데스크톱 드래그 · 모바일 탭).
- **방 방문 · 소통** — 랜덤 또는 닉네임으로 다른 사용자의 방을 방문하고, 댓글·좋아요로 소통합니다.
- **공유 · 계정** — QR 코드로 내 방을 외부에 공유하고, 카카오 OAuth로 로그인합니다.
