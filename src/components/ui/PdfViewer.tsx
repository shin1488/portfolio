    ...
    >
      ...
      >
        ...
        {!error && !interactive && (
          ...
          >
            <span className="flex h-16 w-16 items-center justify-center rounded-full bg-blue-600/90 shadow-lg backdrop-blur-sm transition group-hover:scale-105">
      ...
      {interactive && (
        ...
        >
          ...
          >
            <div
              className="absolute inset-y-0 left-0 rounded-full bg-linear-to-r from-green-400 to-blue-700 transition-[width] duration-200"
      ...
      {isFullscreen && (
        ...
        >
          <div
            className="h-full bg-linear-to-r from-green-400 to-blue-700 transition-[width] duration-200"
            style={{ width: `${progressPct}%` }}
          />
        </div>
      )}
