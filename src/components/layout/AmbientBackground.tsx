...
export function AmbientBackground() {
  return (
    <div aria-hidden="true" className="ambient-hue pointer-events-none fixed inset-x-0 top-0 bottom-[calc(env(safe-area-inset-bottom)+4.5rem)] -z-10 overflow-hidden">
