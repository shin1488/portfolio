          ...
          <ol className="pb-1.5 pt-0.5">
            {entries.map((entry, index) => (
              <li key={entry.id}>
                ...
                >
                  <span className="w-4.5 shrink-0 font-mono text-[13px] tabular-nums text-zinc-400 transition-colors group-hover:text-green-400 dark:text-zinc-500">
                    {String(index + 1).padStart(2, '0')}
                  </span>
                  <span className="text-[15px] text-zinc-700 group-hover:bg-linear-to-r group-hover:from-green-400 group-hover:to-blue-500 group-hover:bg-clip-text group-hover:text-transparent dark:text-zinc-300">
                    {entry.text}
                  </span>
                </a>
              </li>
