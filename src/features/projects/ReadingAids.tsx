...
export function ReadingAids({ entries }: ReadingAidsProps) {
  ...
  return (
    <>
      ...
      >
        <div
          className="w-full rounded-full bg-linear-to-b from-green-700 to-blue-800"
            ...
            >
              ...
              <span className="max-w-0 overflow-hidden opacity-0 transition-all duration-300 group-hover:max-w-60 group-hover:opacity-100">
                <span
                  className={cn(
                    ...
                    active
                      ? 'bg-linear-to-r from-green-700 to-blue-800 bg-clip-text font-medium text-transparent'
              ...
              <span
                ...
                className={cn(
                  ...
                  active ? 'w-5 bg-blue-800' : 'w-2.5 bg-zinc-400/60 dark:bg-zinc-600',
                )}
              />
            </a>
          );
                ...
                >
                  <span
                    ...
                    className={cn(
                      ...
                      active ? 'w-5 bg-green-700' : 'w-2.5 bg-zinc-400/60 dark:bg-zinc-600',
                    )}
                  />
                  ...
                  <span className="grid">
                    ...
                    <span
                      aria-hidden="true"
                      className={cn(
                        'col-start-1 row-start-1 line-clamp-1 max-w-42 bg-linear-to-r from-green-700 to-blue-800 bg-clip-text text-transparent transition-opacity',
